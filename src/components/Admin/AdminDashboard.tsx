...
import { getWinnerNameByOrderNumber } from '@/lib/utils';
                  ...
                  <div className="flex bg-white/5 p-1 rounded-xl border border-white/10">
                    {(['geral', 'diaria', 'semanal', 'mensal'] as const).map((filter) => (
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest transition-all ${rankingFilter === filter
