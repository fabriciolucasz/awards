...
import { MOCK_USERS, MOCK_RAFFLE, MOCK_CONTRIBUTORS, MOCK_TICKETS } from '@/lib/data';
import { Page, Raffle, User, Contributor, Ticket } from '@/lib/types';
import { getWinnerNameByOrderNumber, maskName, maskPhone } from '@/lib/utils';
...
export default function RaffleClient({ slug }: RaffleClientProps) {
  ...
  const pricePerTicket = raffle.pricePerTicket;
            ...
            <main className="max-w-2xl mx-auto px-4 mt-8 space-y-8">
              ...
              <motion.div variants={itemVariants} className="space-y-2">
                <h1 className="text-3xl font-black tracking-tight font-display leading-tight">
                  ...
                  <span className="text-emerald-400">{raffle.title.includes('(') ? `(${raffle.title.split('(')[1]}` : ''}</span>
                </h1>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {raffle.mysteryBox.prizes
                    ...
                    .map((prize) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${prize.winnerOrderNumber ? 'bg-gray-500/20' : 'bg-emerald-500/20'
                            }`}>
